...
public class ClientServicesProxy implements IServices {
    ...
    @Override
    public void submitInscriere(DTOSubmit infoSubmit) throws ServerException {
    ...
    public Angajat[] getLoggedEmployees() throws ServerException {
        ...
        Response response = readResponse();
        if(response.type()==ResponseType.ERROR){
            String err = response.getClass().toString();
    ...
    @Override
    public DTOBJParticipant[] searchByTeam(String team) throws ServerException {
        ...
        return  (DTOBJParticipant[])response.data();
    }
